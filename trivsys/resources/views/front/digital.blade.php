...
@section('home')
    ...
    {{-- baner section start --}}
    <div class="w-full h-[200px] md:h-[500px] overflow-hidden bg-blue-500">
        <div class="w-full h-full overflow-hidden">
            <img class="w-[100%] h-[100%]" src="{{ asset('storage/img/digital.png') }}" alt="">
        </div>
    </div>
    {{-- baner section end --}}
    ...
    <div class="w-full h-auto mt-6">
        <div class="w-full h-full px-6 py-10 flex flex-col lg:flex-row justify-between">
            ...
            <div class="w-full lg:w-[49%] h-full mb-8 lg:mb-0  md:sticky top-0 left-0">
                ...
                <p class="text-4xl font-bold">Our Digital Marketing Expertise</p>
